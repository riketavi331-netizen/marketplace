  ...
  if (items.length === 0) {
    return (
      <div className="text-center py-16 md:py-24">
        ...
        <h2 className="text-xl font-semibold mb-2 text-gray-700">Корзина пуста</h2>
        <p className="text-gray-400 mb-6 text-sm">Добавьте товары из каталога</p>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">
        Корзина <span className="text-gray-400 font-normal text-base">({items.length})</span>
      </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="card p-4 md:p-6 space-y-4 lg:sticky lg:top-20">
            <h2 className="font-semibold text-base md:text-lg">Оформление</h2>
            <div>
